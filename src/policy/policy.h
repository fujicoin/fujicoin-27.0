...
static constexpr unsigned int DEFAULT_BLOCK_MIN_TX_FEE{10000000};
...
static constexpr unsigned int DEFAULT_INCREMENTAL_RELAY_FEE{10000000};
...
static constexpr unsigned int DEFAULT_MIN_RELAY_TX_FEE{10000000};
