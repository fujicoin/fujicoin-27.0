// Copyright (c) 2012-2022 The Fujicoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.fujicoincore.org", "www.fujicoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.fujicoincore.org]", "www.fujicoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.fujicoincore.org:80", "www.fujicoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.fujicoincore.org]:80", "www.fujicoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.fujicoincore.org:65536", "www.fujicoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.fujicoincore.org:0", "www.fujicoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.fujicoincore.org:", "www.fujicoincore.org:", 0, false));
}
