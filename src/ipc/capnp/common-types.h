...
#ifndef FUJICOIN_IPC_CAPNP_COMMON_TYPES_H
#define FUJICOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common fujicoin types.
namespace mp {
...
#endif // FUJICOIN_IPC_CAPNP_COMMON_TYPES_H
