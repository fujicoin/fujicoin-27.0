    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &FujicoinGUI::createWallet);
...
void FujicoinGUI::createActions()
{
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Fujicoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Fujicoin Transaction from clipboard"));
    ...
    connect(quitAction, &QAction::triggered, this, &FujicoinGUI::quitRequested);
    ...
    if(walletFrame)
    {
        ...
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const std::pair<const std::string, bool>& i : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &FujicoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &FujicoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &FujicoinGUI::createWallet);
        connect(m_close_all_wallets_action, &QAction::triggered, [this] {
            m_wallet_controller->closeAllWallets(this);
        });
        connect(m_migrate_wallet_action, &QAction::triggered, [this] {
            auto activity = new MigrateWalletActivity(m_wallet_controller, this);
            connect(activity, &MigrateWalletActivity::migrated, this, &FujicoinGUI::setCurrentWallet);
            activity->migrate(walletFrame->currentWalletModel());
        });
        connect(m_mask_values_action, &QAction::toggled, this, &FujicoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &FujicoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET
...
void FujicoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &FujicoinGUI::setCurrentWalletBySelectorIndex);
...
void FujicoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
...
#ifdef ENABLE_WALLET
void FujicoinGUI::enableHistoryAction(bool privacy)
{
...
void FujicoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &FujicoinGUI::addWallet);
...
WalletController* FujicoinGUI::getWalletController()
{
...
void FujicoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::coinsSent, this, &FujicoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &FujicoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &FujicoinGUI::incomingTransaction);
...
void FujicoinGUI::createTrayIconMenu()
{
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &FujicoinGUI::toggleHidden);
...
void FujicoinGUI::gotoLoadPSBT(bool from_clipboard)
{
...
void FujicoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Fujicoin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void FujicoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void FujicoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void FujicoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    ...
    connect(dlg, &OptionsDialog::quitOnReset, this, &FujicoinGUI::quitRequested);
...
void FujicoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void FujicoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
#ifdef ENABLE_WALLET
void FujicoinGUI::incomingTransaction(const QString& date, FujicoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
...
static bool ThreadSafeMessageBox(FujicoinGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = FujicoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
bool FujicoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<FujicoinUnit> units = FujicoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const FujicoinUnit unit : units) {
...
{
    menu = new QMenu(this);
    for (const FujicoinUnit u : FujicoinUnits::availableUnits()) {
        menu->addAction(FujicoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(FujicoinUnit newUnits)
{
