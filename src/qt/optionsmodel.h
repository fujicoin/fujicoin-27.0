...
#ifndef FUJICOIN_QT_OPTIONSMODEL_H
#define FUJICOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Fujicoin client.
...
public:
    ...
    FujicoinUnit getDisplayUnit() const { return m_display_fujicoin_unit; }
...
private:
    ...
    QString language;
    FujicoinUnit m_display_fujicoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(FujicoinUnit unit);
...
#endif // FUJICOIN_QT_OPTIONSMODEL_H
