...
#ifndef FUJICOIN_ARITH_UINT256_H
#define FUJICOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Fujicoin only uses this "compact" format for encoding difficulty
...
#endif // FUJICOIN_ARITH_UINT256_H
