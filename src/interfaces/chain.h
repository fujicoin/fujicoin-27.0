...
#ifndef FUJICOIN_INTERFACES_CHAIN_H
#define FUJICOIN_INTERFACES_CHAIN_H
...
//! internal workings of the fujicoin node, and not being very convenient to use.
...
#endif // FUJICOIN_INTERFACES_CHAIN_H
