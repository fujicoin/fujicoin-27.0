...
#ifndef FUJICOIN_INTERFACES_INIT_H
#define FUJICOIN_INTERFACES_INIT_H
...
//! (fujicoin-gui, fujicoin-node, fujicoin-wallet, fujicoind, fujicoin-qt) and each
...
#endif // FUJICOIN_INTERFACES_INIT_H
