...
#ifndef FUJICOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define FUJICOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // FUJICOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
