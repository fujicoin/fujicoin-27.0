...
complete --command fujicoind --no-files

# Extract options
function __fish_fujicoind_get_options
...
complete \
    --command fujicoind \
    --arguments "(__fish_fujicoind_get_options --nofiles)"
