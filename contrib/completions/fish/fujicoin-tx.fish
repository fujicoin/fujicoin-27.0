...
# Extract options
function __fish_fujicoin_tx_get_options
...
# Extract commands
function __fish_fujicoin_tx_get_commands
...
complete \
    --command fujicoin-tx \
    --condition "not __fish_fujicoin_seen_cmd (__fish_fujicoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_fujicoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command fujicoin-tx \
    --arguments "(__fish_fujicoin_tx_get_commands)" \
    --no-files
