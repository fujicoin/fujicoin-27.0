...
complete --command fujicoin-qt --no-files

# Extract options
function __fish_fujicoinqt_get_options
...
complete \
    --command fujicoin-qt \
    --arguments "(__fish_fujicoinqt_get_options --nofiles)"
