...
"""Example logging Fujicoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/fujicoind
...
def main(fujicoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[fujicoind_with_usdts])
