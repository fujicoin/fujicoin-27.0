...
""" Example logging Fujicoin Core mempool events using the mempool:added,
...
def main(fujicoind_path):
    ...
    # to the tracepoints
    fujicoind_with_usdts.enable_probe(probe="mempool:added", fn_name="trace_added")
    fujicoind_with_usdts.enable_probe(probe="mempool:removed", fn_name="trace_removed")
    fujicoind_with_usdts.enable_probe(probe="mempool:replaced", fn_name="trace_replaced")
    fujicoind_with_usdts.enable_probe(probe="mempool:rejected", fn_name="trace_rejected")
