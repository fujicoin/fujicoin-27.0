#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Fujicoin Core developers
...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef FUJICOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define FUJICOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the fujicoin network\n')
    ...
    g.write('#endif // FUJICOIN_CHAINPARAMSSEEDS_H\n')
