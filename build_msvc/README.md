...
Introduction
---------------------
Visual Studio 2022 is minimum required to build Fujicoin Core.

Solution and project files to build with `msbuild` or Visual Studio can be found in the `build_msvc` directory.

To build Fujicoin Core from the command-line, it is sufficient to only install the [Visual Studio Build Tools](https://visualstudio.microsoft.com/downloads/) component.
...
```cmd
msbuild build_msvc\fujicoin.sln -property:Configuration=Release -maxCpuCount -verbosity:minimal
```
