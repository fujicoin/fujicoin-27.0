...
export CONTAINER_NAME=ci_native_nowallet_libfujicoinkernel
...
export GOAL="install"
export FUJICOIN_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
