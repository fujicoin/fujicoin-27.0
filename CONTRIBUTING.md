...
First, in terms of structure, there is no particular concept of "Fujicoin Core
...
Before you start contributing, familiarize yourself with the Fujicoin Core build
system and tests. Refer to the documentation in the repository on how to build
Fujicoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
The developer
[mailing list](https://groups.google.com/g/fujicoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/fujicoindev/](https://gnusha.org/pi/fujicoindev/).
...
fork of Fujicoin Core copies the merge. Instead, make any username mentions in a
