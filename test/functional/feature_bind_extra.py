...
"""
Test starting fujicoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(FujicoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that fujicoind has bound on "::1" (for RPC) and "::" (for P2P).
