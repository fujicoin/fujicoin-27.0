...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/fujicoin/fujicoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(FujicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our fujicoind node")
