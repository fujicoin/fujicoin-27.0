...
By default, fujicoind will dump mempool on shutdown and
...
class MempoolPersistTest(FujicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent fujicoind from writing mempool.dat to disk. Verify that `savemempool` fails")
