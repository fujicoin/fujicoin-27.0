...
to a hash that has been compiled into fujicoind.
...
class AssumeutxoTest(FujicoinTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test fujicoind should fail when mempool not empty.")
        node=self.nodes[2]
