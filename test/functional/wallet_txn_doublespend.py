...
class TxnMallTest(FujicoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 FJC:
        ...
        # First: use raw transaction API to send 1240 FJC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FJC coin each
        ...
        # Node0's balance should be starting balance, plus 50FJC for another
        ...
        # Node0's total balance should be starting balance, plus 100FJC for
