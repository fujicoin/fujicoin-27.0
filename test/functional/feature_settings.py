...
class SettingsTest(FujicoinTestFramework):
    ...
    def run_test(self):
        ...
        conf = node.datadir_path / "fujicoin.conf"

        # Assert default settings file was created
        self.stop_node(0)
        default_settings = {"_warning_": "This file is automatically generated and updated by Fujicoin Core. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
