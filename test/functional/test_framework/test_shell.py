...
class TestShell:
    """Wrapper Class for FujicoinTestFramework.

    The TestShell class extends the FujicoinTestFramework
    ...
    class __TestShell(FujicoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by FujicoinTestFramework child class.
            self.num_nodes = 1
