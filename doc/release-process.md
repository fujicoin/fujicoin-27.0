...
* Update fujicoin.conf and commit, see [gen-fujicoin-conf.sh](https://github.com/fujicoin/fujicoin/blob/master/contrib/devtools/README.md#gen-fujicoin-confsh).
...
- Upload to the fujicoincore.org server (`/var/www/bin/fujicoin-core-${VERSION}/`):
...
- Update other repositories and websites for new version
  ...
  - Delete post-EOL [release branches](https://github.com/fujicoin/fujicoin/branches/all) and create a tag `v${branch_name}-final`.
