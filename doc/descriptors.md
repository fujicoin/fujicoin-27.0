# Support for Output Descriptors in Fujicoin Core

Since Fujicoin Core v0.17, there is support for Output Descriptors. This is a
...
on Fujicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Fujicoin Core descriptor wallet to serve as your
...
existing Fujicoin Core wallets, a convenience function `combo` is
...
All RPCs in Fujicoin Core will include the checksum in their output. Only
