Fujicoin Core version 27.0 is now available from:

  <https://fujicoincore.org/bin/fujicoin-core-27.0/>
...
libfujicoinconsensus
-------------------

- libfujicoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libfujicoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Fujicoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Fujicoin Core would
